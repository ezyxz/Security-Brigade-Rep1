...
func ReadFlattenedRawSets(file io.Reader, reversed bool) (setIDs []string, rawSets [][]string, err error) {
...
func ReadFlattenedSortedRawSets(file io.Reader) (setIDs []string, rawSets [][]string, err error) {
	// Create raw sets by merging flattened entries.
	setIDs = make([]string, 0)
	rawSets = make([][]string, 0)
